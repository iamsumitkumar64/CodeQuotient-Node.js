...
const app = express()
const data = require('./Fake_Date.json')
const fs = require('fs');
...
// };
const use_file = (req) => {
    const en_data = `\t${req.url}\n`
    fs.appendFile('route_Access.txt', en_data, (err) => {
